...
| external\_id  | string           | Time entry external ID                                                                       |
| created\_at   | string           | Time entry creation timestamp                                                                |
| updated\_at   | string           | Time entry update timestamp                                                                  |
| entry\_date   | string           | Entry date of event in time tracking system                                                  |
...
* [List all shifts](/reference/link-shifts)

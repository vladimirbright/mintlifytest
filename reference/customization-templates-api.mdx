...
| document\_upload       | object   | Configuration object for Document upload template    |
...
* [List all customizable templates](/reference/v1_templates_list) - GET /templates/
* [Create a customizable template](/reference/v1_templates_create) - POST /templates/
* [Retrieve a customizable template](/reference/v1_templates_read) - GET /templates/\{template\_id}/
* [Update a customizable template](/reference/v1_templates_partial_update) - PATCH /templates/\{template\_id}/
* [Delete a customizable template](/reference/v1_templates_delete) - DELETE /templates/\{template\_id}/

...
![](/images/reference/deee042-Orders_in_dashboard.png "Orders in dashboard.png")
...
Create a new key in [Truv Dashboard](http://dashboard.truv.com/app/development/keys).

2. **Delete the old key**.

Delete unnecessary access\_token values to minimize exposure to attacks. Pending state transactions with the original key continue to process.

![](/images/reference/0e2e923-Integration_and_orders_via_API.png "Integration and orders via API.png")
...
Generate a new key in [Truv Dashboard](http://dashboard.truv.com/app/development/keys).

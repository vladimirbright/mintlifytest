...
| ----------- | --------- | -------------------------------------------------------------------- |
| id          | string    | Unique ID                                                            |
| created\_at | date-time | Timestamp when account was created in Truv                           |
| updated\_at | date-time | Timestamp when account last updated in Truv                          |
| type        | string    | Account type                                                         |
| subtype     | string    | Account subtype                                                      |
| mask        | string    | Last 4 digits of account number                                      |
| nickname    | string    | Description of account                                               |
| balances    | object    | List of balance information, see [Balances object](#balances-object) |
...
* [List all balances](/reference/balances-list)

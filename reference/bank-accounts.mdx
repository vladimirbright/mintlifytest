...
| account\_name   | string | User-friendly account name for bank account                                                                                                      |
| account\_type   | string | Account type of bank account, includes two types`C` - Checking account`S` - Saving account                                                       |
| deposit\_type   | string | Deposit type of bank account, three types of deposits available`E` - Entire paycheck`P` - Percentage of paycheck`A` - Fixed amount from paycheck |
| deposit\_value  | string | Deposit value of selected bank account                                                                                                           |
...
* [List all bank accounts](/reference/link-bank-accounts)
